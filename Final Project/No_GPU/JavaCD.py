...
def compute_class_weights(train_loader, device):
    ...
    label_counts = torch.zeros(7)  # For 7 Java categories
    total_samples = 0
...
if __name__ == "__main__":
    ...
    # Define categories
    categories = [
    'TestsVerification', 'Unknown', 'Functionality',
    'FeaturesAttributes', 'ReferencesLinks', 'TechnicalLimitations', 'ImplementationDetails'
    ]
    ...
    with open('model_results.txt', 'w') as f:
        f.write("Java Comment Classification Results\n")
        f.write("=" * 50 + "\n\n")
